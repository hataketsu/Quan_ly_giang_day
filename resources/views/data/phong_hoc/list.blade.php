                ...
                <div class="box box-solid box-primary">
                    ...
                    <div class="box-body">
                        <div class="btn-group pull-right">
                            <a href="/phong_hoc/create" class="btn bg-green"><i class="fa fa-plus"></i> Thêm
                                phòng học mới</a>
                        ...
                        <br>
                        <br>
                        <form action="/phong_hoc/mass_delete" method="post" id="main_list_form">
                            @csrf
                            <table id="main_table" class="table table-bordered table-hover">
                                ...
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a class="btn btn-primary" href="/phong_hoc/{{$item->id}}/edit">
