            ...
            <div class="col-md-12">
                <div class="box ">
                    ...
                    <div class="box-body">
                        ...
                        {!!BootForm::select("ngay_trong_tuan[]","Ngày trong tuần",\App\Phan_cong_giang_day::getDayOfWeek(),json_decode($item->ngay_trong_tuan),['multiple' => 'multiple','class'=>'select2'])!!}
                        {!!BootForm::date("ngay_bat_dau","Ngày bắt đầu")!!}
                        {!!BootForm::date("ngay_ket_thuc","Ngày kết thúc")!!}
